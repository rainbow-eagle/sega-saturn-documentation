...
However, the .O objects contained whithin the archives or as individuals files respect the standard and can be converted by sh-elf-objcopy, with the notable exception of SGLAREA.O, discussed later in this document.
